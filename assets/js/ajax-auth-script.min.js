    ...
    e('body').on('submit', 'form#login, form#register', function (a) {
        e('p.status', this).show().text(ajax_auth_object.loadingmessage),
            ...
            'register' == e(this).attr('id') &&
                ((action = 'ajaxregister_custom'), (username = e('#signup_name').val()), (password = e('#signup_password').val()), (email = e('#signup_email').val()));
        (ctrl = e(this)),
            e.ajax({
                type: 'POST',
                dataType: 'json',
                ...
                success: function (a) {
                    ...
                    e('p.status', ctrl).text(a.message), 1 == a.loggedin ? document.location.reload() : 'register' == ctrl;
                    1 == a.registered ? document.location.reload() : 'register' == ctrl;
                }
            }),
            a.preventDefault();
    }),
