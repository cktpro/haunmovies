...
+(function (t) {
            ...
            t.proxy(function () {
              o[n](null == s[e] ? this.options[e] : s[e]),
                'loadingText' == e
                  ...
                  : this.isLoading &&
                    ((this.isLoading = !1), o.removeClass(i).removeAttr(i).prop(i, !1));
            }, this),
            0
          );
      }),
  ...
  +(function (t) {
    ...
    function e(e) {
      ...
      i ||
        ((i = e.attr('href')), (i = i && /#[A-Za-z]/.test(i) && i.replace(/.*(?=#[^\s]*$)/, '')));
      var o = i && t(i);
  ...
  +(function (t) {
    ...
    (i.VERSION = '3.3.7'),
      ...
      (i.prototype.show = function () {
        ...
        if (this.hasContent() && this.enabled) {
          ...
          if (d) {
            ...
            (r =
              'bottom' == r && h.bottom + c > f.bottom
                ? 'top'
                : 'top' == r && h.top - c < f.top
                ? 'bottom'
                : 'right' == r && h.right + p > f.width
                ? 'left'
                : 'left' == r && h.left - p < f.left
                ? 'right'
                : r),
          ...
          t.support.transition && this.$tip.hasClass('fade')
            ? s.one('bsTransitionEnd', m).emulateTransitionEnd(i.TRANSITION_DURATION)
            : m();
        }
      }),
      ...
      (i.prototype.getPosition = function (e) {
        ...
        null == n.width &&
          (n = t.extend({}, n, { width: n.right - n.left, height: n.bottom - n.top }));
