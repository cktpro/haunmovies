...
var HaLim = {
    ...
    setHistory: function (item = false) {
        ...
        bi_historys.unshift([DoPostInfo.id, DoPostInfo.url, DoPostInfo.name, DoPostInfo.ep_name, DoPostInfo.image, Math.floor(date.getTime() / 1000)]);
    ...
    listBookmark: function () {
        if (jQuery('#bookmark-list4').length <= 0) {
            return;
        }
        ...
        $(document).ready(function () {
            ...
            if (Object.keys(halim_bookmark).length > 0) {
                ...
                $('#bookmark-list4').html('<span style="text-align:center;color:#ccc;">Bạn chưa lưu bookmark!</span>');
            }
        });
    },
    ...
    Bookmark: function () {
        if (typeof Storage !== 'undefined') {
            ...
            if (typeof halim_cfg !== 'undefined' && halim_bookmark[halim_cfg.post_id]) {
                $('#bookmark4').addClass('bookmarked');
            }
            $('#bookmark4').click(function () {
                if (!$(this).hasClass('bookmarked')) {
                    ...
                    if (halim_bookmark[post_id] == undefined) {
                        ...
                        showCustomToast('success', 'Thêm vào bookmark thành công');
                    ...
                    localStorage['halim_bookmark'] = JSON.stringify(halim_bookmark);
                    showCustomToast('error', 'Xóa bookmark thành công');
                }
                return false;
            });
