...
class HaLim_Movie_Pagination_Widget extends WP_Widget {

	public function __construct() {
		parent::__construct(
			'halim-movie-pagination-widget',
			__( 'HaLim Movie Pagination Widget', 'halimthemes' ),
			array(
				'classname'   => 'halim-movie-pagination-widget',
				'description' => __( 'Display posts by category, latest, most viewed, last update with pagination', 'halimthemes' )
			)
		);
	}
	...
	public function widget( $args, $instance ) {
		...
		// End add get page
				...
				// add function paginate
				halim_pagination();
				// end add function paginate
			?>
			</div>
		</section>
...
function _HaLim_Movie_Pagination_Widget() {
	register_widget( 'HaLim_Movie_Pagination_Widget' );
}
add_action( 'widgets_init', '_HaLim_Movie_Pagination_Widget' );